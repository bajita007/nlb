            ...
            media: [
                {
                    ...
                    type: "audio",
                    downloadUrl: "https://twin.web.id/media/hipnoterapi/AFIRMASI IBU HAMIL PERSALINAN LANCAR KEHAMILAN SEHAT.mp3",
                },
                {
                    url: "/music-placeholder.png",
                    title: "Afirmasi Positif untuk Hamil Sehat bagi Bumil _ Relaksasi Kesehatan Ibu Hamil",
                    type: "audio",
                    downloadUrl: "https://twin.web.id/media/hipnoterapi/Afirmasi Positif untuk Hamil Sehat bagi Bumil _ Relaksasi Kesehatan Ibu Hamil.mp3",
                },
                {
                    url: "/video-placeholder.png",
                    title: "Bagaimana Caranya Kalimat Positif Dapat Membantu Persalinan",
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/hipnoterapi/Bagaimana Caranya Kalimat Positif Dapat Membantu Persalinan .mp4",
                },
                {
                    url: "/music-placeholder.png",
                    title: "BIMBINGAN KETENANGAN PIKIRAN SAAT HAMIL (Lepaskan Cemas & Khawatir)",
                    type: "audio",
                    downloadUrl: "https://twin.web.id/media/hipnoterapi/BIMBINGAN KETENANGAN PIKIRAN SAAT HAMIL (Lepaskan Cemas & Khawatir).mp3",
                },
            ],
        },
        {
            ...
            media: [
                {
                    ...
                    title: "Heal [N°171]",
                    type: "audio",
                    downloadUrl: "https://twin.web.id/media/hidroterapi/Heal [N°171].mp3",
                },
                {
                    url: "https://twin.web.id/media/hidroterapi/Hidroterapi.jpg",
                    title: "Hidroterapi",
                    type: "image",
                    downloadUrl: "https://twin.web.id/media/hidroterapi/Hidroterapi.jpg",
                },
                {
                    url: "/music-placeholder.png",
                    title: "Learn To See [N°170]",
                    type: "audio",
                    downloadUrl: "https://twin.web.id/media/hidroterapi/Learn To See [N°170].mp3",
                },
                {
                    url: "/music-placeholder.png",
                    title: "Recharge [N°169]",
                    type: "audio",
                    downloadUrl: "https://twin.web.id/media/hidroterapi/Recharge [N°169].mp3",
                },
            ],
        },
        {
            ...
            media: [
                {
                    ...
                    type: "audio",
                    downloadUrl: "https://twin.web.id/media/mindfullness/Sering Merasa Overthingking  Lakukan Meditasi Mindfulness Ini Untuk Mengatasinya!.mp3",
                },
                {
                    url: "https://twin.web.id/media/mindfullness/mindfullness.jpg",
                    title: "mindfullness",
                    type: "image",
                    downloadUrl: "https://twin.web.id/media/hidroterapi/mindfullness.jpg",
                },
            ],
        },
        {
            ...
            media: [
                {
                    ...
                    title: "Heal [N°171]",
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/terapi/Heal [N°171].mp4",
                },
                {
                    url: "https://twin.web.id/media/terapi/terapi musik lembut.jpg",
                    title: "Terapi musik lembut",
                    type: "image",
                    downloadUrl: "https://twin.web.id/media/terapi/terapi musik lembut.jpg",
                },
                {
                    url: "/video-placeholder.png",
                    title: "Learn To See [N°170]",
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/terapi/Learn To See [N°170].mp4",
                },
                {
                    url: "/video-placeholder.png",
                    title: "Recharge [N°169]",
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/terapi/Recharge [N°169].mp4",
                },
            ],
        },
        {
            ...
            media: [
                {
                    ...
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/yoga/IBU & ANAK_ Yoga Prenatal untuk Persiapan Persalinan.mp4",
                },
                {
                    url: "/video-placeholder.png",
                    title: "PANDUAN MUDAH YOGA IBU HAMIL TRIMESTER 3 DI RUMAH",
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/yoga/PANDUAN MUDAH YOGA IBU HAMIL TRIMESTER 3 DI RUMAH.mp4",
                },
                {
                    url: "/video-placeholder.png",
                    title: "Latihan Pernafasan selama hamil sampai persalinan, agar melahirkan lebih nyaman bersama Tasya Kamila",
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/yoga/Latihan Pernafasan selama hamil sampai persalinan, agar melahirkan lebih nyaman bersama Tasya Kamila.mp4",
                },
                {
                    url: "/video-placeholder.png",
                    title: "Teknik Bernafas Untuk Kurangi Kecemasan pada Ibu Hamil _ Prenatal Yoga Part 11",
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/yoga/Teknik Bernafas Untuk Kurangi Kecemasan pada Ibu Hamil _ Prenatal Yoga Part 11.mp4",
                },
                {
                    url: "/video-placeholder.png",
                    title: "Yoga Mengurangi Nyeri Tulang Pinggang dan Punggung bersama Jamilatus Sa diyah",
                    type: "video",
                    downloadUrl: "https://twin.web.id/media/yoga/Yoga Mengurangi Nyeri Tulang Pinggang dan Punggung bersama Jamilatus Sa diyah (1).mp4",
                },
                {
                    url: "/video-placeholder.png",
                    ...
                    downloadUrl: "https://twin.web.id/media/yoga/Mengurangi Nyeri Persalinan Dengan Endorfin Massage.mp4",
                },
            ],
        },
