    ...
    try {
      ...
      if (permission === "granted") {
        ...
        if (userSession) {
          ...
          if (result.success) {
            ...
            toast({
              title: "Berhasil",
              description:
                "Notifikasi push telah diaktifkan untuk perangkat ini",
            });

            if (serviceWorkerRegistration) {
              serviceWorkerRegistration.showNotification(
                "Lentera Bunda - Notifikasi Aktif",
                {
        ...
        toast({
          ...
          description:
            "Silakan berikan izin notifikasi untuk mengaktifkan fitur ini.",
          variant: "destructive",
        });
      }
    } catch (error) {
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Terima notifikasi di semua perangkat Anda
                  </p>
              ...
              <Switch
                checked={pushEnabled}
                onCheckedChange={() =>
                  !pushEnabled && handleEnablePushNotifications()
                }
              />
            </div>
            ...
            {!isEnablingPush && (
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  ...
                  Browser akan meminta izin notifikasi.
                </p>
              </div>
            )}
