-- Create health_units table if it doesn't exist
CREATE TABLE IF NOT EXISTS health_units (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    name VARCHAR(100) NOT NULL UNIQUE,
    type VARCHAR(20) NOT NULL DEFAULT 'Puskesmas',
...
-- Insert seed data for health_units (only if table is empty)
...
-- Insert seed data for questionnaire_questions (10 pertanyaan EPDS)
