-- Create health_units table untuk tempat konsultasi (tanpa menghapus yang sudah ada)
...
-- Create questionnaire_questions table (tanpa menghapus yang sudah ada)
...
-- Insert seed data untuk health_units (hanya jika belum ada)
...
-- Insert seed data untuk questionnaire_questions (hanya jika belum ada)
...
-- Create indexes for better performance (hanya jika belum ada)
...
-- Create function to update respondent count (hanya jika belum ada)
...
-- Create triggers to automatically update respondent count (hapus dulu jika ada, lalu buat baru)
...
-- Update initial respondent counts untuk data yang sudah ada
UPDATE health_units 
SET respondent_count = (
    SELECT COUNT(*) 
    FROM respondents 
